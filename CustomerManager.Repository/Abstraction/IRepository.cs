...
public interface IRepository
{
	...
	public Task<bool> CheckIfEndProductIsUsed(int productId, CancellationToken ct = default);
	public Task<IEnumerable<InvoiceProducts>> GetAllInvoiceProductsByProductId(int productId, CancellationToken ct = default);
